...
public class BeanGenerator {
	...
	private String getHelpers(Entry<String, String> field) {
		...
		String lcFirstName = Utils.LcFirst(name), ucFirstName = Utils
				.UcFirst(name);
	...
	public void WriteBean(String tableName, Map<String, String> fields)
			throws Exception {
		// Folder
		...
		Queue<Entry<String, String>> queue = new LinkedList<Entry<String, String>>(
				fields.entrySet());
